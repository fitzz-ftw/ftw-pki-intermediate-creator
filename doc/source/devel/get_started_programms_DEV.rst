...
>>> from ftwpki.intermed_creator.cli_parser import CSRIntermediateParser_DEV

>>> from ftwpki.baselibs.configuration import IntermedPKIConfig_DEV

>>> pre_parser = CSRIntermediateParser_DEV(add_help=False, allow_abbrev=False)
...
>>> ca_parser = CSRIntermediateParser_DEV(prog="ftwpkicsrinter")
